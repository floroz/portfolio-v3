  ...
  work: [
    {
      ...
      description: [
        ...
        "Served as the key individual for DevOps tasks within the team, implementing CI/CD using monorepo tooling (Lerna, NX, Node.js, GitHub Actions) and creating release pipelines (alpha, beta, stable) for efficient distribution through the NPM registry. Pioneered testing best practices using tools like Cypress, Percy, and Vitest, and formulated a comprehensive strategy to ensure quality. Involved Designers and QAs in the review and approval process for releases, enhancing collaborative quality control.",
        ...
        "Conducted extensive investigations of open-source component libraries and build tooling to ensure compatibility between our internal libraries and the frameworks used by other teams (Vite, Nuxt.js, and Tailwind). Experimented with creating dedicated Storybook plugins to enhance the authoring experience by introducing a custom Vue templating syntax using AST parsing. Actively participated in discussions regarding the Storybook architecture roadmap and played a key role in identifying and reviewing bugs and issues within the Vue ecosystem.",
      ],
    },
    {
